  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '4rem', background: '#000000' }}>
        ...
        {sections.map((s) => (
          <div key={s.title} style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '6rem 0', background: s.bg }}>
            <div className="max-w-site">
              <div className="services-section" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center', direction: s.imageRight ? 'rtl' : 'ltr' }}>
                <div style={{ direction: 'ltr' }}>
                  ...
                  <p style={{ fontFamily: B, fontSize: '1rem', color: 'rgba(255,255,255,0.65)', lineHeight: 1.75, margin: '0 0 2rem' }}>{s.copy}</p>
                ...
                <div style={{ direction: 'ltr', height: 320, background: 'rgba(255,255,255,0.08)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.15)' }}>
